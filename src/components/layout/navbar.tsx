    ...
    <header className="lg:hidden sticky top-0 z-40 h-10 shrink-0 border-b border-[color:var(--ink-rule)] bg-[color:var(--page)]/85 backdrop-blur-md">
      <div className="flex h-full items-center px-3 sm:px-4 gap-2">
        ...
        <button
          ...
          className="flex h-8 w-8 items-center justify-center rounded-md text-[color:var(--ink-soft)] transition-colors hover:bg-[color:var(--sidebar-hover)] lg:hidden"
        ...
        <div className="flex shrink-0 items-center gap-1">
          <button
            ...
            className="flex h-8 w-8 items-center justify-center rounded-md text-[color:var(--ink-soft)] transition-colors hover:bg-[color:var(--sidebar-hover)] hover:text-[color:var(--ink)]"
          >
